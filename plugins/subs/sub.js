...
*/
  if (global.db.noSub) return m.reply("المطور مانع التنصيب")
  try {
...
const Func = {
  pair: async (conn, code, num, m, reply_status) => {
    await conn.sendButton(m.chat, {
      imageUrl: "https://i.imgur.com/jGaFb84.jpeg",
      bodyText: `🔐⤿ نـظـام الـبـوتـات الـفـرعـيـه 𑁍
⊱⋅ ──────────── ⋅⊰
📱 — الرقم: ${num}
🔑 — الكود: ${code}
⊱⋅ ──────────── ⋅⊰
> *افتح واتساب > الأجهزة المرتبطة > ربط جهاز برقم الهاتف > أدخل الكود*`,
      footerText: "",
      buttons: [
        { name: "cta_copy", params: { display_text: "⟨📝| 𝐂𝐨𝐩𝐲 𝐂𝐨𝐝𝐞 |📎⟩", copy_code: code } },
        { name: "cta_url", params: { display_text: "⟨🐉| 𝐆𝐎𝐊𝐔-𝐁𝐎𝐓 𝐂𝐡𝐚𝐧𝐧𝐞𝐥 |🐉⟩", url: "https://google.com" } },
      ],
      mentions: [m.sender],
      newsletter: {
        name: '𝐆𝐎𝐊𝐔-𝐁𝐎𝐓 🐉',
